...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            logging.info("Splitting train and test data into dependent and independent features")
            ...
            logging.info("Best model found, model name is {}, accuracy score is {}".format(best_model_name,best_model_score))
